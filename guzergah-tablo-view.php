      ...
      <div class="col-md-12">
        <div class="x_panel">
          <div class="x_title">
            <div class="row">
              <div class="col-md-5">
                <h2>Okul Adı <b><?php echo $row2['is_adresi_adi']; ?></b></h2>
              </div>
              <div class="col-md-7">
                <h2>Şoför Adı-Soyadı <b><?php echo $row2['sofor_adi_soyadi']; ?></b></h2>
              </div>
            </div>
          ...
          <div class="x_content">
            ...
            <table class="table table-striped projects">
              <thead>
                <tr>
                  ...
                  <th style="width: 10%">Telefon No</th>
                  <th style="width: 9%">Saati</th>
            ...
            <input style="display: none" type="text" id="gkm" value="<?php echo $km_bil; ?>">
...
<script async defer
src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDM_6jfMJTRQSG8bNhogTcAGvI2S1fYg6A&callback=initMap">
</script>
